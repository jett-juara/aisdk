...
import { MusicConcertAndSportEventManagement as MusicAndSportContent } from "@/components/product"
import type { LucideIcon } from "lucide-react"
import { Route, Rocket, Users, PartyPopper, ClipboardList } from "lucide-react"

export default function MusicConcertAndSportEventManagementPage() {
  ...
  const items = [
    { slug: "audience-flow-management", name: "Audience Flow", icon: Route },
    { slug: "creative-agency", name: "Creative Agency", icon: Rocket },
    { slug: "music-concert-and-sport-event-management", name: "Music & Sport", icon: PartyPopper },
    { slug: "event-activation", name: "Event Activation", icon: ClipboardList },
    { slug: "mice-event", name: "MICE Event", icon: Users },
  ]
  ...
  return (
    <div className="container mx-auto px-4 py-10">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-6 w-full">
        {items.map((item) => {
          const isSelected = item.slug === "music-concert-and-sport-event-management"
      ...
      <MusicAndSportContent stage={detailStage} />
    </div>
  )
}