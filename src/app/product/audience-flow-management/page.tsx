...
import { AudienceFlowManagement as AudienceFlowManagementContent } from "@/components/product"
import type { LucideIcon } from "lucide-react"
import { Route, Rocket, Users, PartyPopper, ClipboardList } from "lucide-react"

export default function AudienceFlowManagementPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-10">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-6 w-full">
        {items.map((item) => {
          const isSelected = item.slug === "audience-flow-management"
      ...
      <AudienceFlowManagementContent stage={detailStage} />
    </div>
  )
}