  ...
  return (
    <div className="container mx-auto px-4 py-10">
          ...
          <div className="w-full py-6 lg:py-8">
            ...
            >
              <div className="order-1 lg:basis-[40%] flex flex-col w-full cursor-pointer" onClick={() => router.push('/product-services')}>
              ...
              <div className="order-2 lg:basis-[60%] p-4 lg:p-8 flex flex-col gap-6 pr-0 lg:pr-10">
