            ...
            <svg className="hidden lg:block absolute inset-0 z-0 w-full h-full opacity-[0.20] pointer-events-none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    ...
                    <mask id="collaboration-vertical-fade-mask">
                        <linearGradient id="collaboration-vertical-fade-gradient" x1="0" y1="0" x2="0" y2="1">
                ...
                <rect width="100%" height="100%" fill="url(#collaboration-grid-pattern)" mask="url(#collaboration-vertical-fade-mask)" />
            </svg>
