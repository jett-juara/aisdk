...
export default function HomePage() {
  return (
    <div className="relative isolate flex flex-col md:overflow-hidden lg:overflow-hidden bg-black min-h-dvh md:h-dvh lg:h-dvh [&_*]:focus:outline-none [&_*]:focus-visible:outline-none [&_*]:focus-visible:ring-0 [&_*]:focus-visible:ring-offset-0">
      ...
      <div
        className="pointer-events-none absolute top-0 left-0 w-full h-dvh z-0 bg-[url('/images/home-hero/dark-hero-home-mobile.webp')] md:bg-[url('/images/home-hero/dark-hero-home-tablet.webp')] lg:bg-[url('/images/home-hero/dark-hero-home.webp')] bg-cover bg-center"
        aria-hidden="true"
      />

      {/* 30% Dark Shadow Overlay */}
      <div className="pointer-events-none absolute top-0 left-0 w-full h-dvh z-10 bg-black/30" />
