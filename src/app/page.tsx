...
export default function HomePage() {
  return (
    <div className="relative isolate flex min-h-screen min-h-dvh flex-col overflow-hidden bg-black">
      ...
      <div
        className="pointer-events-none absolute inset-0 z-0 bg-[url('/images/home-hero/hero_03-mobile.webp')] bg-cover bg-center md:bg-[url('/images/home-hero/hero_03-tablet.webp')] lg:bg-[url('/images/home-hero/hero_03-xlarge.webp')]"
        aria-hidden="true"
      />
