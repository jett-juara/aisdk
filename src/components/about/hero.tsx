              ...
              <div className="w-full lg:max-w-[35vw]">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-4 auto-rows-[minmax(100px,auto)]">
                  {items.map((item, index) => {
                    ...
                    else if (index === 1) bentoClass = "col-span-1 row-start-2 col-start-1 aspect-square md:col-span-1 md:row-start-1 md:col-start-3 lg:col-span-1 lg:row-span-2 lg:row-start-1 lg:col-start-3 lg:aspect-[1/2] lg:h-full"
                    else if (index === 2) bentoClass = "col-span-1 row-span-2 row-start-1 col-start-2 h-full md:col-span-1 md:row-start-2 md:col-start-1 md:aspect-square md:row-span-1 md:h-auto lg:col-span-1 lg:row-span-1 lg:row-start-3 lg:col-start-1 lg:aspect-square lg:h-full"
