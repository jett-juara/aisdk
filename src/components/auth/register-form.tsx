...
export default function RegisterForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      {/* Name Fields */}
      <div className="grid grid-cols-1 lg:grid-cols-1 gap-6 lg:gap-6">
      ...
      {/* Register Button */}
      <Button type="submit" className="w-full font-button font-medium text-md bg-button-primary text-text-100 hover:bg-button-primary-hover active:bg-button-primary-active tracking-wide rounded-lg transition-all duration-500 ease-out h-10">
        Daftar
      </Button>
