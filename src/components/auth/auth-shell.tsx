  ...
  return (
    <section className="bg-background-900 min-h-screen">
      <div className="flex min-h-screen">
        {/* Left: Form */}
        <div className="bg-background-900 w-full md:w-2/5 flex flex-col justify-between px-16 pb-12 md:pb-16">
          {/* Header-aligned logo */}
          <div className="-mx-16 flex h-16 items-center px-4 sm:px-6 lg:px-8">
            <HeaderLogo />
          </div>
          ...
          <div className="flex-1 flex flex-col justify-center">
            {(title || subtitle) && (
              <div className="mb-8">
                {title && (<h1 className="font-heading font-bold text-5xl text-text-200">{title}</h1>)}
                {subtitle && (<p className="font-body text-2xl text-text-50">{subtitle}</p>)}
              </div>
            )}
            {left}
          </div>
          ...
          {/* Footer */}
          <div className="text-center space-y-1 font-body text-lg text-text-200">
            <p>
        ...
        {/* Right: Testimonial */}
        <div className="hidden md:flex w-3/5 flex-col px-16 pb-16 md:pb-16 bg-background-800">
          {/* Top bar on testimonial side, align with header spacing like logo */}
          <div className="-mx-16 flex h-16 items-center justify-end px-4 sm:px-6 lg:px-8">
