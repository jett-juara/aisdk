...
export default function MusicConcertAndSportEventManagement({ stage }: { stage: "idle" | "cards" | "content" }) {
  const router = useRouter()
  const paragraphs = [
    "Produksi high-energy untuk konser musik dan event olahraga: ritme, crowd dynamics, dan momentum jadi satu narasi panggung.",
    "Advanced sound engineering, stage design modular, dan visual system (projection mapping, lighting) untuk pengalaman imersif.",
    "Operasional presisi: talent routing, run of show, safety & compliance, dan koordinasi lintas-stakeholder berjalan rapih.",
    "Analytics pasca event untuk mengukur brand impact, audience retention, dan rekomendasi peningkatan event berikutnya.",
  ]
  return (
    <div className="w-full py-6 lg:py-8">
      ...
      >
        <div className="order-2 lg:order-1 lg:basis-[60%] p-4 lg:p-8 flex flex-col gap-4 pr-0 lg:pr-10">
          <h2 className="text-2xl font-heading font-semibold">High-Energy Music & Sport Production</h2>
