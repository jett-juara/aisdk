...
export default function EventActivation({ stage }: { stage: "idle" | "cards" | "content" }) {
    ...
    <div className="w-full py-6 lg:py-8">
      ...
      >
        <div className="order-2 lg:order-1 lg:basis-[60%] p-4 lg:p-8 flex flex-col gap-4 pr-0 lg:pr-10">
          <h2 className="text-2xl font-heading font-semibold">Experiential Brand Activation</h2>
