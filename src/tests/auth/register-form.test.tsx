...
describe('RegisterForm', () => {
  ...
  it('validates password confirmation mismatch', async () => {
    ...
    fireEvent.change(screen.getByLabelText(/^kata sandi$/i), { target: { value: 'Password1' } })
    fireEvent.change(screen.getByLabelText(/konfirmasi kata sandi/i), { target: { value: 'Password2' } })
